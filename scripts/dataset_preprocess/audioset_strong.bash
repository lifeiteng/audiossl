...
python gen_tsv.py --meta_path $meta_path --audio_path $DATA_ROOT/zip_audios
...
python common_label_filtrate.py --meta_path $meta_path
...
python intersected_event_filtrate.py --meta_path $meta_path
...
# data: 
#   strong_folder: "YOUR_PATH/zip_audios"
#   strong_folder_44k: "YOUR_PATH/zip_audios"
#   strong_train_tsv:  "YOUR_PATH/meta/train/train_rm_intersect.tsv"
#   strong_val_tsv: "YOUR_PATH/meta/eval/eval_rm_intersect.tsv"
#   test_folder: "YOUR_PATH/zip_audios"
#   test_folder_44k: "YOUR_PATH/zip_audios"
